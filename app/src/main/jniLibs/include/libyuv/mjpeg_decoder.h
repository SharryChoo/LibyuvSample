...
class LIBYUV_API MJpegDecoder {
 public:
  ...
  // to point to after the end of the written i420Bytes.
  // TODO(fbarchard): Add dst_x, dst_y to allow specific rect to be decoded.
  LIBYUV_BOOL DecodeToBuffers(uint8_t** planes, int dst_width, int dst_height);

  // Decodes the entire image and passes the i420Bytes via repeated calls to a
  // callback function. Each call will get the i420Bytes for a whole number of
  // image scanlines.
  // TODO(fbarchard): Add dst_x, dst_y to allow specific rect to be decoded.
 ...
 private:
  ...
  // A buffer holding the input i420Bytes for a frame.
  Buffer buf_;
