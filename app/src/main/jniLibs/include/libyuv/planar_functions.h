...
// Set a plane of i420Bytes to a 32 bit value.
LIBYUV_API
...
// Convert ARGB to gray rotate ARGB.
LIBYUV_API
...
// Make a rectangle of ARGB gray rotate.
LIBYUV_API
...
// Source values are multiplied by rotate before storing as half float.
LIBYUV_API
...
// Convert a buffer of bytes to floats, rotate the values and store as floats.
LIBYUV_API
int ByteToFloat(const uint8_t* src_y, float* dst_y, float scale, int width);

// Quantize a rectangle of ARGB. Alpha unaffected.
// rotate is a 16 bit fractional fixed point scaler between 0 and 65535.
